...
<pattern id="EFORMS-validation-stage-1b-4" xmlns="http://purl.oclc.org/dsdl/schematron">
	<rule context="/*[$noticeSubType = '4']">
		...
		<assert id="ND-Lot-4" role="ERROR" diagnostics="ND-Lot" test="count(cac:ProcurementProjectLot) &gt; 0">rule|text|ND-Lot-4</assert>
	...
	<rule context="/*/cac:ProcurementProjectLot[$noticeSubType = '4']">
		<assert id="ND-LotProcurementScope-4" role="ERROR" diagnostics="ND-LotProcurementScope" test="count(cac:ProcurementProject) &gt; 0">rule|text|ND-LotProcurementScope-4</assert>
		<assert id="ND-LotTenderingTerms-4" role="ERROR" diagnostics="ND-LotTenderingTerms" test="count(cac:TenderingTerms) &gt; 0">rule|text|ND-LotTenderingTerms-4</assert>
	...
	<rule context="/*/cac:ProcurementProjectLot/cac:TenderingTerms[$noticeSubType = '4']">
		...
		<assert id="ND-LotReviewTerms-4" role="ERROR" diagnostics="ND-LotReviewTerms" test="count(cac:AppealTerms) &gt; 0">rule|text|ND-LotReviewTerms-4</assert>
