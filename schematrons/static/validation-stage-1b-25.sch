...
<pattern id="EFORMS-validation-stage-1b-25" xmlns="http://purl.oclc.org/dsdl/schematron">
	<rule context="/*[$noticeSubType = '25']">
		...
		<assert id="ND-Lot-25" role="ERROR" diagnostics="ND-Lot" test="count(cac:ProcurementProjectLot) &gt; 0">rule|text|ND-Lot-25</assert>
	...
	<rule context="/*/cac:ProcurementProjectLot[$noticeSubType = '25']">
	...
	<rule context="/*/cac:ProcurementProjectLot/cac:ProcurementProject[$noticeSubType = '25']">
	...
	<rule context="/*/cac:ProcurementProjectLot/cac:TenderingProcess[$noticeSubType = '25']">
	...
	<rule context="/*/cac:ProcurementProjectLot/cac:TenderingTerms[$noticeSubType = '25']">
	...
	<rule context="/*/cac:ProcurementProjectLot/cac:TenderingTerms/cac:AwardingTerms[$noticeSubType = '25']">
