...
<pattern id="EFORMS-validation-stage-1b-39" xmlns="http://purl.oclc.org/dsdl/schematron">
	<rule context="/*[$noticeSubType = '39']">
		...
		<assert id="ND-Lot-39" role="ERROR" diagnostics="ND-Lot" test="count(cac:ProcurementProjectLot) &gt; 0">rule|text|ND-Lot-39</assert>
	...
	<rule context="/*/cac:ProcurementProjectLot[$noticeSubType = '39']">
	...
	<rule context="/*/cac:ProcurementProjectLot/cac:ProcurementProject[$noticeSubType = '39']">
	...
	<rule context="/*/cac:ProcurementProjectLot/cac:TenderingProcess[$noticeSubType = '39']">
	...
	<rule context="/*/cac:ProcurementProjectLot/cac:TenderingTerms[$noticeSubType = '39']">
	...
	<rule context="/*/cac:ProcurementProjectLot/cac:TenderingTerms/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension[$noticeSubType = '39']">
	...
	<rule context="/*/ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/efext:EformsExtension/efac:Organizations[$noticeSubType = '39']">
		...
		<assert id="ND-UBO-39" role="ERROR" diagnostics="ND-UBO" test="count(efac:UltimateBeneficialOwner) = 0">rule|text|ND-UBO-39</assert>
	</rule>
