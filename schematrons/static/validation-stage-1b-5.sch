...
<pattern id="EFORMS-validation-stage-1b-5" xmlns="http://purl.oclc.org/dsdl/schematron">
	<rule context="/*[$noticeSubType = '5']">
		...
		<assert id="ND-Lot-5" role="ERROR" diagnostics="ND-Lot" test="count(cac:ProcurementProjectLot) &gt; 0">rule|text|ND-Lot-5</assert>
	...
	<rule context="/*/cac:ProcurementProjectLot[$noticeSubType = '5']">
		<assert id="ND-LotProcurementScope-5" role="ERROR" diagnostics="ND-LotProcurementScope" test="count(cac:ProcurementProject) &gt; 0">rule|text|ND-LotProcurementScope-5</assert>
		<assert id="ND-LotTenderingTerms-5" role="ERROR" diagnostics="ND-LotTenderingTerms" test="count(cac:TenderingTerms) &gt; 0">rule|text|ND-LotTenderingTerms-5</assert>
	...
	<rule context="/*/cac:ProcurementProjectLot/cac:TenderingTerms[$noticeSubType = '5']">
		...
		<assert id="ND-LotReviewTerms-5" role="ERROR" diagnostics="ND-LotReviewTerms" test="count(cac:AppealTerms) &gt; 0">rule|text|ND-LotReviewTerms-5</assert>
